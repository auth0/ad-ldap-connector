...
var exports = module.exports = function(settings){
    ...
    return function(req, res, next){
        ...
        req.session = exports.readSession(
            s.session_key, s.secret, s.timeout, s.session_cookie, req);
...
exports.deserialize = function(secret, timeout, sessionCookie, str){
    ...
    if(!exports.valid(secret, timeout, sessionCookie, str)){
...
exports.valid = function(secret, timeout, sessionCookie, str){
...
exports.readSession = function(key, secret, timeout, sessionCookie, req){
    // Reads the session data stored in the cookie named 'key' if it validates,
    // otherwise returns an empty object.

    var cookies = exports.readCookies(req);
    if(cookies[key]){
        return exports.deserialize(secret, timeout, sessionCookie, cookies[key]);
    }
    return {};
};
